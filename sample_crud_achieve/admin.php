...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit_item'])) {
    ...
    $stmt->bind_param("ssdisd", $name, $description, $price, $quantity, $image, $id);
    // Fix: id is int
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .view-store:hover { border-color: var(--brand); color: var(--brand); }
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="index.php" class="nav-item" target="_blank"><i class="fas fa-store"></i> View Storefront</a>
        <a href="cart.php"  class="nav-item" target="_blank"><i class="fas fa-shopping-cart"></i> View Cart</a>
    </nav>
...
<div class="main">
    <div class="topbar">
        ...
        <div class="topbar-right">
            <a href="index.php" class="view-store" target="_blank"><i class="fas fa-external-link-alt"></i> Storefront</a>
